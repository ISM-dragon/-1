...
export default function Studio({ jobs, running, stages, error, onRun, onCancel, onOpenLoop, onOpenSocial, onOpenSources, onOpenProviders, onOpenAiUsage, onOpenJob, onResume, isAndroid }: Props) {
